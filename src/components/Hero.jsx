                    ...
                    <div className="flex flex-col md:flex-row items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                                ...
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="border border-cyan-400 text-cyan-400 px-8 py-3 rounded-full font-medium text-lg"
                                >
                                    Learn More
                                </motion.button>
                            </div>
                        ...
                        >
                            <div className="relative">
                                <div className="w-64 h-64 md:w-80 md:h-80 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center shadow-2xl shadow-cyan-500/30">
